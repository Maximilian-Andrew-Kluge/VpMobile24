// VpMobile24 Card v2.4.3
console.info('%c VpMobile24-CARD %c v2.4.3 ', 'color: orange; font-weight: bold; background: black', 'color: white; font-weight: bold; background: dimgray');
...
console.log('✅ VpMobile24 Card v2.4.3 loaded');
